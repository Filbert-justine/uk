...
<center>
    ...
    <form action="/Poin_Pelanggaran_Siswa/process/guru_process.php" method="POST">
            <table cellpadding="10">
                ...
                <tr>
                    <td><input type="text" name="nama_guru" autocomplete="off" value="<?=$result['nama_pengguna']?>" required placeholder="Nama guru"/></td>
                </tr>
                <tr>
                    <td><input type="text" name="username" autocomplete="off" value="<?=$result['username']?>" required placeholder="Username"/></td>
                </tr>
                <tr>
                    <td><input type="password" name="password" autocomplete="off" placeholder="Ganti Password"/></td>
                </tr>
                <tr>
...
<!-- 
	...
	•	Setelah pengguna mengisi data guru, data akan dikirim ke /Poin_Pelanggaran_Siswa_XIIRPL3/process/guru_process.php menggunakan metode POST.
