                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($data_ortu['status_dokumen'] == NULL) { ?>
                                ...
                                <button class="btn-primary">
                                    <a href="/Poin_Pelanggaran_Siswa/pages/laporan/detail_pelanggaran.php?nis=<?= $data_ortu['nis'] ?>&tanggal=<?= $data_ortu['tanggal_surat'] ?>">Detail</a>
                                </button>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } elseif ($data_laporan_siswa['status_dokumen'] == "Masih Proses") { ?>
                                <button class="btn-primary">
                                    <a href="/Poin_Pelanggaran_Siswa/pages/laporan/detail_pelanggaran.php?nis=<?= $data_laporan_siswa['nis'] ?>&tanggal=<?= $data_laporan_siswa['tanggal_surat'] ?>">Detail Pelanggaran</a>
                                </button>
                                <hr>
                                <button class="btn-primary">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } elseif ($data_laporan_ortu['status_dokumen'] == "Selesai") { ?>
                                <a href="/Poin_Pelanggaran_Siswa/gambar/<?= htmlspecialchars($data_laporan_ortu['foto_dokumen']) ?>"
                                   target="_blank" class="btn-primary"
                                   style="text-decoration:none;color:white;font-family:'Arial';font-size:13px;">Lihat Gambar</a>
                            <?php } ?>
                        </td>
